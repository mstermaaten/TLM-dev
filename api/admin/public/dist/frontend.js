...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/frontend/strapi/dashboard/dashboard.html',
    '<div class="row"><div class="col-sm-12"><h1 class="page-header">Dashboard</h1><div class="panel panel-default"><div class="panel-heading">Welcome to your admin panel</div><div class="panel-body"><p>Lets get productive with The Learning Machine!</p></div></div></div></div>');
}]);
})();
